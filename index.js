...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Michael Agam.\n' //MICHAEL AGAM 
            + 'ORG: tbz.;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=62814622392081:+62 82217590187\n'  //ganti nomor lu! 
            + 'END:VCARD'
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6282217590187@s.whatsapp.net"]   //ganti nomor lu! 
const pacarNumber = ["6282217590187@s.whatsapp.net"]  //ganti nomor lu!  
/************************************/
...
─────────────────────`
	...
	client.on('message-new', async (mek) => {
		...
		if (urutan_pesan === 5000) {
		    ...
		    const ulangtahun = await axios.get('https://xinzbot-api.herokuapp.com/api/hitungmundur?apikey=XinzBot&tanggal=8&bulan=10')
		    ...
		    const ucap = await axios.get('https://xinzbot-api.herokuapp.com/api/ucapan?apikey=XinzBot&timeZone=Asia/Jakarta')
